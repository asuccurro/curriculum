...
\headedsubsection{\color{gray} Achieved Skills}{\color{gray} Bioinformatics, Biochemistry Laboratory, R, dynamic FBA, Kinetic Modelling, Teaching}
...
\headedsubsection{\color{gray} Key achievements}{\color{gray} Biology, Flux Balance Analysis, Matlab, Biochemistry, Linear Programming}
...
\headedsubsection{\color{gray} Key achievements}{\color{gray} Monte Carlo techniques, Statistical Analysis, 
